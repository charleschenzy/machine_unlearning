...
def split_train_test_data(data_name):
    ...
    torch.save((train_idx, valid_idx), 'train_valid_idx_'+data_name+'.pt')
...
def prepare_dataset_by_name(data_name):
    if data_name == 'mnist':
        ...
        trainset,testset = prepare_cifar100_dataset()
