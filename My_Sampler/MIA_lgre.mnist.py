...
from model.MNIST_LogisticRegression import LogisticRegression
...
def load_parameters(args):
    ...
    return model,model_param_list,nable_grad_u_list,hvp_nable_grad_list,train_data_ids
...
def Federated_Unlearning():
    ...
    trainloader = torch.utils.data.DataLoader (trainset, batch_size=2048, sampler=train_sampler,
    ...
    unlearn_params_list = add_params_to_model(hvp_nable_grad_list, init_global_model)
    #init_global_model.load_state_dict (model_para)
